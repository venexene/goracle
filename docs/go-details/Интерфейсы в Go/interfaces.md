...
> Нормы языка и открытые интерфейсы отделяются от внутреннего представления среды выполнения.
...
Подробные правила дерева ошибок и пример приведены в главе [«Ошибки в Go»](../Ошибки%20в%20Go/errors.md#errorsastype-go-126).
