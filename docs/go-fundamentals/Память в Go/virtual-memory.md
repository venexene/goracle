...
>
> **После чтения:** вы сможете различить виртуальное адресное пространство, физические страницы, RSS и память кучи Go.
>
...
равна 8 КБ, а размер страницы ОС зависит от платформы и конфигурации.
...
Изучите, как среда выполнения делит полученные диапазоны на
