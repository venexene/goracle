...
![](assets/b7hszrPBK4oniYBcwhsMfcEcyhQ9-oB5edHm3yqtVWw=.png)

* **`count`** — количество элементов в мапе.
* **`B`** — логарифм по основанию 2 от количества бакетов (если бакетов 4, то `B = 2`).
...
![](assets/bzAwpeFyeyBBt8UT1em5w39iyJBSlX30wcqDszqV_AE=.png)
...
![](assets/9zF5e6Bkq6UyAfKNMiQ-iuBWDgIHp1cRsvS1Y79sAkc=.png)
...
![](assets/gIaM5SNs0n8EOpTfx3w9xxQW8R7FKEBpTWve85i-PPo=.png)
...
![](assets/yWhriuPUMm49gdvKM5KBtsTyHaKmBkVKHXTkBrzKJh0=.png)
