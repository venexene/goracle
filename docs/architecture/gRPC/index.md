...
> Нормы протокола, открытые интерфейсы библиотек и сгенерированный код зависят от закреплённых версий инструментов.
...
Формат и версии в примере сверены с [официальным руководством Buf по удалённым модулям генерации](https://buf.build/docs/bsr/remote-plugins/).
