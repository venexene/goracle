...
и свойства сообщения. Новый потребитель сообщения создаёт дочерний участок трассы или
связь, а не случайный несвязанный идентификатор. Не используйте идентификатор трассы
